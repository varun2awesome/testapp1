...
public class AuthenticationAgentActivity_CoreWebViewClient extends WebViewClient implements IGCUserPeer {
    ...
    static {
        Runtime.register("Microsoft.Identity.Client.Platforms.Android.EmbeddedWebview.AuthenticationAgentActivity+CoreWebViewClient, Microsoft.Identity.Client", AuthenticationAgentActivity_CoreWebViewClient.class, "n_onLoadResource:(Landroid/webkit/WebView;Ljava/lang/String;)V:GetOnLoadResource_Landroid_webkit_WebView_Ljava_lang_String_Handler\nn_shouldOverrideUrlLoading:(Landroid/webkit/WebView;Ljava/lang/String;)Z:GetShouldOverrideUrlLoading_Landroid_webkit_WebView_Ljava_lang_String_Handler\nn_onPageFinished:(Landroid/webkit/WebView;Ljava/lang/String;)V:GetOnPageFinished_Landroid_webkit_WebView_Ljava_lang_String_Handler\nn_onPageStarted:(Landroid/webkit/WebView;Ljava/lang/String;Landroid/graphics/Bitmap;)V:GetOnPageStarted_Landroid_webkit_WebView_Ljava_lang_String_Landroid_graphics_Bitmap_Handler\n");
    }

    public AuthenticationAgentActivity_CoreWebViewClient() {
        if (getClass() == AuthenticationAgentActivity_CoreWebViewClient.class) {
            TypeManager.Activate("Microsoft.Identity.Client.Platforms.Android.EmbeddedWebview.AuthenticationAgentActivity+CoreWebViewClient, Microsoft.Identity.Client", "", this, new Object[0]);
        }
    }

    public AuthenticationAgentActivity_CoreWebViewClient(String str, Activity activity) {
        if (getClass() == AuthenticationAgentActivity_CoreWebViewClient.class) {
            TypeManager.Activate("Microsoft.Identity.Client.Platforms.Android.EmbeddedWebview.AuthenticationAgentActivity+CoreWebViewClient, Microsoft.Identity.Client", "System.String, mscorlib:Android.App.Activity, Mono.Android", this, new Object[]{str, activity});
        }
    }
