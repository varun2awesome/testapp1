...
public final class CustomTabsSession {
    ...
    public CustomTabsSession(ICustomTabsService service, ICustomTabsCallback callback, ComponentName componentName, @Nullable PendingIntent sessionId) {
    ...
    public static class PendingSession {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        public PendingSession(@Nullable CustomTabsCallback callback, @Nullable PendingIntent sessionId) {
            this.mCallback = callback;
            this.mId = sessionId;
        }
