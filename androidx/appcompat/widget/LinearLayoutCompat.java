            ...
            while (i36 < virtualChildCount) {
                ...
                if (virtualChildAt2 == null) {
                    ...
                    if (z7) {
                        ...
                        i12 = max;
                        this.mTotalLength = Math.max(i37, i37 + i19 + ((ViewGroup.MarginLayoutParams) layoutParams2).leftMargin + ((ViewGroup.MarginLayoutParams) layoutParams2).rightMargin + getNextLocationOffset(virtualChildAt2));
                        i36++;
                        max = i12;
                    }
                }
            ...
            while (i43 < virtualChildCount) {
                ...
                if (virtualChildAt3 == null || virtualChildAt3.getVisibility() == 8) {
                    ...
                    if (z7) {
                        ...
                        f = f2;
                        this.mTotalLength = Math.max(i46, virtualChildAt3.getMeasuredWidth() + i46 + ((ViewGroup.MarginLayoutParams) layoutParams3).leftMargin + ((ViewGroup.MarginLayoutParams) layoutParams3).rightMargin + getNextLocationOffset(virtualChildAt3));
                    }
